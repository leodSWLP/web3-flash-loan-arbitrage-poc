...
abstract contract V4QuoteMathWithDebug {
    using SafeCast for *;
        ...
        )
    {
        ...
        while (
            ...
            console2.log('step.tickNext: ');
            console2.logInt(step.tickNext);
            console2.log('step.tickNext: ', step.initialized);
            ...
            console2.log('after result.sqrtPriceX96:', result.sqrtPriceX96);
            console2.log('step.amountIn: ', step.amountIn);
            console2.log('step.amountOut: ', step.amountOut);
            console2.log('step.feeAmount: ', step.feeAmount);

            console2.log('before update amountSpecifiedRemaining: ');
            console2.logInt(amountSpecifiedRemaining);
            console2.log('before update amountCalculated: ');
            console2.logInt(amountCalculated);
            // if exactOutput
            if (params.amountSpecified > 0) {
                unchecked {
            ...
            console2.log('after update amountSpecifiedRemaining: ');
            console2.logInt(amountSpecifiedRemaining);
            console2.log('after update amountCalculated: ');
            console2.logInt(amountCalculated);
